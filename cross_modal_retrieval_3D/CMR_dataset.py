...
class CMR_dataset(Dataset):
    def __init__(self,folder_target,folder_query,num_classes = 10,split='train', data_transforms = None):
        ...
        self.query_path,self.query_label = read_2D_data(self.folder_query,extname=".JPEG")
    ...
    def __getitem__(self, index):
        ...
        return pic,lab,target_views,target_lab
